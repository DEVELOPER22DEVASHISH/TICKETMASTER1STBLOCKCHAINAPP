...
const OCCASION_NAME = "ETHE Texas"
...
describe("TokenMaster", () => {
  let TokenMaster
  let deployer , buyer
// to stop duplicacy from each test
  beforeEach( async() => {
...
// await for to block then run test if do not do this test may not pass // send list to main pool/block
  ...
  describe("Occasions", () => {
    ...
    it('Returns occasions related data', async () => {
